...
//                                var durationList = ['2:56','3:15','2:34','2:29'];
				 ...
				 var songs = [{
                               'name' :'Baby Doll',
                                'artist': 'Sunny leone, Kanika Kapoor,Meet Bros.',
                                'album': 'Ragini MMS 2',
                                'duration': '2:56',
                               'fileName': 'song17.mp3',
                            'image': 'song17.jpg'
                            ...
                            {
                                'name': 'Chokra Jawan Re',
                                'artist': 'Arjun Kapoor,Gohar khan,Sunidhi Chauhan ',
                                'album': 'Ishqzade',
                                'duration': '3:15',
                                'fileName': 'song18.mp3',
                                'image': 'song18.jpg'
                            ...
                            {
                               'name': 'Ishq vala love',
                                'artist': 'Aalia Bhatt, Sidharth Malhotra, Varun Dhawan',
                            ...
                            {
                                'name': 'Ik Kudi',
                                'artist': 'Diljit dosannjh, Aalia bhatt',
                                'album' :'Udta Punjab',
                                'duration': '2:29',
                                'fileName': 'song20.mp3',
                                'image': 'song20.jpg'
